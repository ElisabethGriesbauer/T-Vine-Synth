...
param_dist = {
    'ctgan__epochs': [50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000],
    'ctgan__batch_size': [50, 100, 150, 200, 300, 400, 500]
...
random.seed(456)
ctgan.fit(data=real_train)
loss_values = ctgan.synthesiser._model.loss_values
...
synthData = ctgan.generate_samples(1000)
