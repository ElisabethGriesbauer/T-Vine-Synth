...
name <- paste0("./figures/utility_realsupport2_small_CvinePrivBayesCTGANTVAE_randForest_AUC_icml", ".png", sep = "")
...
```{r}
resultsVines <- reading(before_trunc = "output/results_inference_realsupport2_small_totcst_50_0126_trunc", after_trunc = after_trunc, trunc_levels = trunc_levels, how_many = how_many)
```
